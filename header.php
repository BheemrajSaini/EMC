...
<table width="100%">
<tr>
<td><div style="padding-left:100px;" align="right"><span><img src="images/logo1.jpg" alt="Logo" width="60" height="55" /></span></div></td>
<td style="padding-left:20px; max-width:500px;" align="center"><h1>National Institute of Technology Tiruchirappalli<br/></h1><h3>Electrical Complaint Management System</h3></td>
...
<div id="menu">
  ...
  <?php 
   ...
   if($role==5)
   echo '<li><a href="listedinventory.php">Edited Inventory</a></li>';
   if($role==5)
   echo '<li><a href="listdelinventory.php">Deleted Inventory</a></li>';
   if($role==5)
   echo '<li><a href="viewfeed.php">View Feedback</a></li>';
   if($role>=2)
