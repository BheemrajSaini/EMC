...
//changes here
		...
		$sql="Insert into edinventory values('', '".$itemid."','".$_POST['itemname']."','".$_POST['quantity1']."','".$_POST['res']."',";
		$sql.="'" . $time . "'".")";
		mysql_query($sql,$conn);
		
              $sql="UPDATE inventory set quantity=" . $_POST['quantity1'] . " where item LIKE '$name%' ";
		mysql_query($sql,$conn);
