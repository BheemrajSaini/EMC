...
<?php
	...
	if(isset($_POST['newPersonSubmit']))
	{
		...
		if(1)
		{
			$sql="Select id,name,designation,department,location,description,processed,area,time,dispatchedTime,room, contactPerson, contactNumber, timing,descText,availablefrom,availableto,contact from complaints ";
...
//echo $sql; exit();
		...
		$sql="Select id,name,designation,department,location,description,processed,area,time,dispatchedTime, contactPerson, contactNumber, room,timing,descText,availablefrom,availableto,contact from complaints where processed=1 order by time ASC";
