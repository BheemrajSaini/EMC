...
if(typeof(offX) == "undefined")
	offX = -100 // x distance from the mouse.
...
/*	if(datas.length == tmpo.length)
	...
	*/
	...
	if(folowMouse)
	{
		...
		{
			document.getElementById('calendar').style.left = parseInt(tempX)+parseInt(offX)+parseInt(offsets[0])-50 + 'px';
		    document.getElementById('calendar').style.top = parseInt(tempY)+parseInt(offY)+parseInt(offsets[1])-50 + 'px';
		}
		else
		{
			document.getElementById('calendar').style.left = parseInt(tempX)+parseInt(offX)-50 + 'px';
		    document.getElementById('calendar').style.top = parseInt(tempY)+parseInt(offY)-50 + 'px';
		}
	}
