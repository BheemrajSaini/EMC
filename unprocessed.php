...
$_GET['page']=0;
		...
		if(isset($_POST['print']))
		{
			...
			for($i=0;$i<(count($arr)-1);$i++)
			{
				if(isset($_POST[$arr[$i]]))
				{//changes here	
					$sql="Select id,name,designation,department,location,description,processed,area,time,dispatchedTime, contactPerson, contactNumber, room,timing,descText,availablefrom,availableto,contact from complaints where id=".$arr[$i]."";
					$result=mysql_query($sql,$conn);
				}
			}
			$row=mysql_fetch_array($result);
...
echo "<p style='margin-top: 50px; margin-left:350px;'><b>SIGNATURE OF ATTENDANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;STORES IN - CHARGE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ASSISTANT ENGINEER</b></p>";
		...
		if(1)
		{
			$sql="Select id,name,designation,location,description,processed,area,time, contactPerson, contactNumber, room,timing,descText,availablefrom,availableto,contact from complaints ";
			$status="and";
			$sql.="where ( 1=1 ";
			$status.=" processed=0";
			if ($status=="and")
...
if(isset($_POST['nm']))		
		...
		$sql="Select id,name,designation,location,description,processed,area,time, contactPerson, contactNumber, room,timing,descText,availablefrom,availableto,contact from complaints where processed=0";
...
<br><!--  Date wise search form starts- Vikas meghwani   -->
     <div id="content">
...
if($a==0)
	...
	echo $count1;
 ?>
<br />Technician:<?php echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'; ?><input disabled = "true" type = 'text' id = 'inchargeName' name = 'inchargeName' />
<br />Contact:<?php echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'; ?><input disabled = "true" type = 'text' id = 'inchargeContact' name = 'inchargeContact' />
<br />
</div>
