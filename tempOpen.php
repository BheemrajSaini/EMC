...
function rowclick(rowid,cid)
{
	...
	{	
		...
		for(i=1; i <= totalItems; i++)
		{
			...
			document.getElementById('closeIndent').innerHTML+= "<br /><tr><td>" + itemName + "(s) returned: </td><td><input type = 'text'  name = 'returned" +i+"' id = 'returned" + i + "'  /></td></tr>";
		}				
...
if (isset($_POST['nm']))
{
	...
	{
	echo "<tr><td>". $row['indentNo']."</td><td>".$row['complaintNo']."</td><td></td><td>".$row['status']."</td></tr>";
	}
exit();
}
if (!isset($ids))
