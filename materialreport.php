...
<?php
	if(isset($_POST['Submit']))
	{
		...
		$url = "db.php?datefrom=" . date("d-m-Y",mktime(0,0,0,$datefrom[0],$datefrom[1],$datefrom[2])) . "&dateto=". date("d-m-Y",mktime(0,0,0,$dateto[0],$dateto[1]+1,$dateto[2]));		
		echo '<h1><center><a href = "' . $url . '">Export <b>Materials</b> table to MS - Excel. </a></center></h1>';
...
function validate()
{
	...
	if(document.getElementById("datefrom").value=='')
	{
		...
		document.getElementById("reportGEN").innerHTML ='';
		return false
	}
